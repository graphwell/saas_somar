    ...
    <div className="min-h-screen flex bg-[#0A0F1E]">
      ...
      <div className="w-full lg:w-[40%] flex items-center justify-center p-6 sm:p-12">
        <Card className="w-full max-w-md p-8 sm:p-10 border-white/5 bg-white/[0.02]">
          ...
          {/* Google como alternativa rápida */}
          <div className="relative my-6">
            <div className="absolute inset-0 flex items-center"><span className="w-full border-t border-white/5" /></div>
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-[#0A0F1E] px-3 text-[#6B7280] tracking-widest">ou cadastre com</span>
            </div>
          </div>
          <Button
            type="button"
            variant="ghost"
            className="w-full flex items-center justify-center gap-3 font-semibold bg-white text-black hover:bg-white/90"
